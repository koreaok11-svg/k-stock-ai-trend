...
def api_version(): return jsonify({'ok':True,'version':'kiwoom-real-auto-moneybuttons-v82','watch_interval':WATCH_INTERVAL})

HTML = r'''<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>성일의 AI 주식바람 v82</title><style>
